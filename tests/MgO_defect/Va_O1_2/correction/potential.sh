...
epsilon=9.490229
accuracy=12
omega=0.0603457597605
#EXTRINSIC=--remove
OUTCAR=../OUTCAR-finish
POSCAR=../POSCAR-finish
script_dir=~/../harada/defect_correction/PyDef-0.1/ # path to the directory containing PyDef scripts.
plot_dir=~/../harada/defect_correction/PyDef-0.1/ 
species=`echo Mg O`
