...
THz = 1.0e12        # [/s]
Mu0 = 4.0e-7 * pi
VacuumPermittivity = 1.0 / Mu0 / SpeedOfLight**2 # [F/m] = [C/V/m]

Me = 9.10938215e-31

Bohr = 4e10 * pi * VacuumPermittivity * Hbar**2 / Me  # Bohr radius [A] 0.5291772
Hartree = Me * EV / 16 / pi**2 / VacuumPermittivity**2 / Hbar**2 # Hartree [eV] 27.211398
