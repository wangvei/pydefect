...
class TestCompound(unittest.TestCase):
    ...
    def test_gas_shift(self):
        ...
        cl = CompoundsList.from_vasp_calculations_files(poscar_paths,
                                                        outcar_paths)
        print(cl[0].gas_energy_shift(298.15, 1))
        print(cl)
        print(cl.gas_energy_shifts(298.15, {"O2": 1}))
        print("at T=298.15, O2 pressure = 1")
        print(cl.free_energies(298.15, {"O2": 1}))
        print("at T=298.15, O2 pressure = 1e+4")
        print(cl.free_energies(298.15, {"O2": 1e+4}))
        print("at T=298.15, O2 pressure = 1e+5")
        print(cl.free_energies(298.15, {"O2": 1e+5}))
