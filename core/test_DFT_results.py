...
class UnitcellDftResultsTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        eigenvalues = {Spin.up: np.array(
       [[[-14.1364,   1.    ], [  2.9978,   1.    ], [  2.9978,   1.    ],
         [  2.9978,   1.    ], [  7.479 ,   0.    ], [ 18.6525,   0.    ],
         [ 18.6525,   0.    ], [ 18.6525,   0.    ]],
        [[-13.9805,   1.    ], [  2.0526,   1.    ], [  2.8993,   1.    ],
         [  2.8993,   1.    ], [  8.3965,   0.    ], [ 16.9813,   0.    ],
         [ 18.9958,   0.    ], [ 18.9958,   0.    ]],
        [[-13.5759,   1.    ], [  0.3868,   1.    ], [  2.6721,   1.    ],
         [  2.6721,   1.    ], [  9.8536,   0.    ], [ 15.4092,   0.    ],
         [ 19.4381,   0.    ], [ 19.4381,   0.    ]],
        [[-13.1221,   1.    ], [ -0.9774,   1.    ], [  2.4581,   1.    ],
         [  2.4581,   1.    ], [ 10.6136,   0.    ], [ 15.1306,   0.    ],
         [ 19.2233,   0.    ], [ 19.2233,   0.    ]],
        [[-12.9153,   1.    ], [ -1.5075,   1.    ], [  2.3728,   1.    ],
         [  2.3728,   1.    ], [ 10.7333,   0.    ], [ 15.3147,   0.    ],
         [ 19.0457,   0.    ], [ 19.0457,   0.    ]],
        [[-13.9306,   1.    ], [  1.9735,   1.    ], [  2.7729,   1.    ],
         [  2.7729,   1.    ], [  8.6915,   0.    ], [ 16.5049,   0.    ],
         [ 19.1306,   0.    ], [ 19.1306,   0.    ]],
        [[-13.6143,   1.    ], [  0.7711,   1.    ], [  2.5295,   1.    ],
         [  2.5332,   1.    ], [  9.9851,   0.    ], [ 15.1627,   0.    ],
         [ 19.1168,   0.    ], [ 19.5995,   0.    ]],
        [[-13.1791,   1.    ], [ -0.517 ,   1.    ], [  2.175 ,   1.    ],
         [  2.327 ,   1.    ], [ 11.0794,   0.    ], [ 14.7426,   0.    ],
         [ 18.1219,   0.    ], [ 19.6339,   0.    ]],
        [[-12.8837,   1.    ], [ -1.247 ,   1.    ], [  1.8888,   1.    ],
         [  2.2631,   1.    ], [ 11.4044,   0.    ], [ 15.1238,   0.    ],
         [ 17.611 ,   0.    ], [ 19.4261,   0.    ]],
        [[-12.9493,   1.    ], [ -1.0815,   1.    ], [  1.8251,   1.    ],
         [  2.3726,   1.    ], [ 11.3855,   0.    ], [ 15.0655,   0.    ],
         [ 17.7046,   0.    ], [ 19.496 ,   0.    ]],
        [[-13.3232,   1.    ], [ -0.1161,   1.    ], [  2.0394,   1.    ],
         [  2.6021,   1.    ], [ 10.8135,   0.    ], [ 14.919 ,   0.    ],
         [ 18.3212,   0.    ], [ 19.99  ,   0.    ]],
        [[-13.743 ,   1.    ], [  1.1538,   1.    ], [  2.4897,   1.    ],
         [  2.8252,   1.    ], [  9.473 ,   0.    ], [ 15.7733,   0.    ],
         [ 18.9498,   0.    ], [ 19.6815,   0.    ]],
        [[-13.4202,   1.    ], [  0.4155,   1.    ], [  2.2821,   1.    ],
         [  2.2821,   1.    ], [ 10.808 ,   0.    ], [ 14.0963,   0.    ],
         [ 18.1994,   0.    ], [ 20.1894,   0.    ]],
        [[-13.0858,   1.    ], [ -0.3016,   1.    ], [  1.8392,   1.    ],
         [  2.0718,   1.    ], [ 11.9148,   0.    ], [ 13.5683,   0.    ],
         [ 16.8649,   0.    ], [ 20.4933,   0.    ]],
        [[-12.8004,   1.    ], [ -0.725 ,   1.    ], [  1.1377,   1.    ],
         [  2.0118,   1.    ], [ 12.5168,   0.    ], [ 14.3505,   0.    ],
         [ 16.0304,   0.    ], [ 20.3257,   0.    ]],
        [[-12.7554,   1.    ], [ -0.6608,   1.    ], [  0.6861,   1.    ],
         [  2.1312,   1.    ], [ 12.7568,   0.    ], [ 14.9282,   0.    ],
         [ 15.8278,   0.    ], [ 20.1413,   0.    ]],
        [[-12.9825,   1.    ], [ -0.4211,   1.    ], [  1.0582,   1.    ],
         [  2.3723,   1.    ], [ 12.2422,   0.    ], [ 14.6272,   0.    ],
         [ 16.7207,   0.    ], [ 20.2032,   0.    ]],
        [[-12.8905,   1.    ], [ -0.635 ,   1.    ], [  1.8501,   1.    ],
         [  1.8501,   1.    ], [ 12.4067,   0.    ], [ 12.5923,   0.    ],
         [ 16.1254,   0.    ], [ 21.1754,   0.    ]],
        [[-12.7076,   1.    ], [ -0.7827,   1.    ], [  1.3214,   1.    ],
         [  1.7777,   1.    ], [ 12.5145,   0.    ], [ 13.1844,   0.    ],
         [ 15.7109,   0.    ], [ 21.2011,   0.    ]],
        [[-12.6521,   1.    ], [ -0.4035,   1.    ], [  0.3589,   1.    ],
         [  1.8889,   1.    ], [ 12.9598,   0.    ], [ 14.4795,   0.    ],
         [ 15.2963,   0.    ], [ 20.7678,   0.    ]],
        [[-12.6666,   1.    ], [ -0.9817,   1.    ], [  1.685 ,   1.    ],
         [  1.685 ,   1.    ], [ 12.0862,   0.    ], [ 12.6907,   0.    ],
         [ 15.8269,   0.    ], [ 21.5828,   0.    ]],
        [[-13.2865,   1.    ], [  0.042 ,   1.    ], [  1.8809,   1.    ],
         [  2.4059,   1.    ], [ 11.236 ,   0.    ], [ 14.378 ,   0.    ],
         [ 17.7916,   0.    ], [ 20.2447,   0.    ]],
        [[-12.9293,   1.    ], [ -0.6225,   1.    ], [  1.322 ,   1.    ],
         [  2.1614,   1.    ], [ 12.2754,   0.    ], [ 14.4725,   0.    ],
         [ 16.6366,   0.    ], [ 19.8304,   0.    ]],
        [[-12.7711,   1.    ], [ -0.9032,   1.    ], [  1.1201,   1.    ],
         [  2.0452,   1.    ], [ 12.4892,   0.    ], [ 14.9483,   0.    ],
         [ 16.2195,   0.    ], [ 19.5838,   0.    ]],
        [[-12.8293,   1.    ], [ -0.5655,   1.    ], [  1.3524,   1.    ],
         [  1.7898,   1.    ], [ 13.0016,   0.    ], [ 13.3066,   0.    ],
         [ 15.9116,   0.    ], [ 20.1318,   0.    ]],
        [[-12.6711,   1.    ], [ -0.4187,   1.    ], [  0.5802,   1.    ],
         [  1.6609,   1.    ], [ 13.4357,   0.    ], [ 14.4675,   0.    ],
         [ 15.2594,   0.    ], [ 19.2653,   0.    ]],
        [[-12.715 ,   1.    ], [ -0.3017,   1.    ], [  0.3761,   1.    ],
         [  1.8512,   1.    ], [ 13.5396,   0.    ], [ 14.5505,   0.    ],
         [ 15.4167,   0.    ], [ 19.3251,   0.    ]],
        [[-12.642 ,   1.    ], [ -0.6877,   1.    ], [  1.1518,   1.    ],
         [  1.4743,   1.    ], [ 12.9233,   0.    ], [ 13.563 ,   0.    ],
         [ 15.5076,   0.    ], [ 19.9636,   0.    ]],
        [[-12.6177,   1.    ], [  0.1231,   1.    ], [  0.1231,   1.    ],
         [  1.2747,   1.    ], [ 14.4722,   0.    ], [ 14.4722,   0.    ],
         [ 14.8549,   0.    ], [ 18.1715,   0.    ]]])}

        self._MgO_unitcell = UnitcellDftResults(
            final_structure, total_energy, static_dielectric_tensor,
