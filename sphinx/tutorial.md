...
When you want to correct for all the directories, use
```
python ~/my_bin/pydefect/pydefect/main.py eig --dir_all . --unitcell ../../unitcell/unitcell.json --perfect ../perfect/dft_results.json -s eig.png
```
