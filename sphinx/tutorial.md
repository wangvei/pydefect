...
Details of the process are examined step by step using an example of wurtzite AlN calculated using the PBEsol functional, which is a default of `pydefect`.
