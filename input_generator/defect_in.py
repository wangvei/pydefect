...
<<<<<<< HEAD
        ...
        antisite_configs (array): antisite configurations, e.g., ["Mg_O", "O_Mg"]
        interstitial_coords (3x1 array): coordination of interstitial sites,
=======
...
# The following default setting determines the condition of automatic defect
# calculations.
_EN_DIFF = 1.0
_DISTANCE = 0.2
_CUTOFF = 3.0
